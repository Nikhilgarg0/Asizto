...
const createStyles = (colors) => StyleSheet.create({
  ...
  infoValue: { fontSize: 16, color: colors.text, fontWeight: '500' },
      input: { width: '100%', height: 50, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 12, marginBottom: 15, paddingLeft: 15, color: colors.text, fontSize: 16, justifyContent: 'center' },
    dropdown: { width: '100%', height: 50, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 12, marginBottom: 15, paddingHorizontal: 15 },
